/*
 * This file automatically produced by /usr/applic/packages/mathematica/10.0.0/SystemFiles/Links/WSTP/DeveloperKit/Linux-x86-64/CompilerAdditions/wsprep from:
 *	lbm.tm
